...
module.exports.initialize = function(options, callback) {
  ...
  return async.waterfall([
    ...
    async.apply(tbd.load, options.path),
...
var makeApp = function(options, sources, callback) {
  var app = express(),
      defaultSource = sources["@1x"],
      info = applyInfoDefaults(defaultSource._info);
...
var applyInfoDefaults = function(info) {
  info = info || {};
